...
class DDCoTAgent:
    def __init__(self, llm: LLMClient, prompt_path: Optional[Path] = None):
        self.llm = llm
        self.prompt_path = prompt_path or Path("prompts/ddcot_prompt.txt")
    ...
    def _load_prompt(self) -> PromptTemplate:
        ...
        return PromptTemplate(input_variables=["round_number", "question", "context", "sub_question_answers"], template=template)
    ...
    def run(self, question: str, round_number: int, context_text: str, extra_info: str) -> str:
        prompt = self.prompt_template.format(
            ...
            sub_question_answers=extra_info or ""
        )
